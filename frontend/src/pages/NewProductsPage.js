...
export default function NewProductsPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get(`${API_URL}/api/products?is_new=true&limit=50`);
      ...
      <section className="py-16 md:py-24 bg-[#F5F5F7] dark:bg-[#1C1C1E]">
        <div className="container-lumina">
          ...
          >
            ...
            <h1 className="heading-hero mb-6">Nouveautés</h1>
            <p className="text-body-lg max-w-2xl mx-auto">
              Découvrez nos dernières arrivées. Des produits soigneusement 
              sélectionnés pour vous offrir le meilleur.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              <p className="text-muted-foreground text-lg mb-6">
                Pas de nouveaux produits pour le moment.
              </p>
